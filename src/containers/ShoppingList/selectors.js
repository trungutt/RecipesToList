...
const sum = (accumulator = 0, quantity = 0): number => accumulator + quantity;

const getShoppingIngredients = (recipes: Object, chosenRecipes: Array<Object>): Object => {
...
const getShoppingIngredientsWithUnit = (shoppingIngredients: Object, ingredients: Object): Object =>
...
const getShoppingIngredientsWithUnitDepartment =
